...
public class PhotoActivity extends ActionBarActivity implements View.OnSystemUiVisibilityChangeListener {
    ...
    public static Intent newIntent(Context context, long galleryId){
        Intent intent = new Intent(context, PhotoActivity.class);

        intent.putExtra(EXTRA_GALLERY_ID, galleryId);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (lastFragment == null){
            ...
            if (Intent.ACTION_VIEW.equals(intent.getAction()) && intent.getData() != null){
                String url = intent.getStringExtra(EXTRA_GALLERY_ID);
