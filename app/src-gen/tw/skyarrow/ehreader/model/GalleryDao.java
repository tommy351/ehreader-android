...
public class GalleryDao extends AbstractDao<Gallery, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property PhotoPerPage = new Property(16, Integer.class, "photoPerPage", false, "PHOTO_PER_PAGE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'GALLERY' (" + //
                ...
                "'PHOTO_PER_PAGE' INTEGER);"); // 16: photoPerPage
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Gallery entity) {
        ...
        Integer photoPerPage = entity.getPhotoPerPage();
        if (photoPerPage != null) {
            stmt.bindLong(17, photoPerPage);
        }
    }
    ...
    public Gallery readEntity(Cursor cursor, int offset) {
        Gallery entity = new Gallery( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getInt(offset + 16) // photoPerPage
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Gallery entity, int offset) {
        ...
        entity.setPhotoPerPage(cursor.isNull(offset + 16) ? null : cursor.getInt(offset + 16));
     }
